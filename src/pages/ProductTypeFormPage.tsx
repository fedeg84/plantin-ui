  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 space-y-6">
        ...
        <div className={`flex ${isEditing ? 'justify-between' : 'justify-end'} space-x-3`}>
          {isEditing && (
            <button
              type="button"
          ...
          <div className="flex space-x-3">
            <BackButton
              fallback={fallback}
              label="Cancelar"
              className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 min-h-0"
              showIcon={false}
            />
            <button
              type="submit"
