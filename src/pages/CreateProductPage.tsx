        ...
        <div className="space-y-6">
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {/* Product Attributes */}
              {selectedProductType && selectedProductTypeAttributes && selectedProductTypeAttributes.length > 0 && (
        ...
        <div className="space-y-6">
          <div className="bg-white shadow rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-medium text-gray-900">Seleccionar Tipo de Producto *</h2>
              <button
                type="button"
